...
- Создал манифест для S3 бакета в Yandex Cloud
- Разнес все переменные по отдельным файлам (так чище и безопаснее)
- Настроил права доступа

### 2. MLFlow
- Поднял сервер MLFlow (теперь можно следить за экспериментами)
<img width="756" alt="image" src="https://github.com/user-attachments/assets/d27a35f2-a74a-472b-9462-75179a5f8674" />

- Встроил в CI/CD (автоматизация - наше всё)
- Использовать ML-Flow в контексте проекта можно для:
